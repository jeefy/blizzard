...
[![Go Reference](https://pkg.go.dev/badge/github.com/jeefy/blizzard/v3.svg)](https://pkg.go.dev/github.com/jeefy/blizzard/v3) [![Go Report Card](https://goreportcard.com/badge/github.com/jeefy/blizzard)](https://goreportcard.com/report/github.com/jeefy/blizzard)
...
```shell
go get github.com/jeefy/blizzard/v3
```
...
import (
  ...
  "github.com/jeefy/blizzard/v3"
  "github.com/jeefy/blizzard/v3/oauth"
  "golang.org/x/oauth2"
)
...
See the [Blizzard API reference](https://develop.battle.net/documentation/guides) and the [Go reference](https://pkg.go.dev/github.com/jeefy/blizzard/v3) for all the different datasets that can be acquired. For questions and discussion about the blizzard API go to the [Blizzard API Forum](https://us.forums.blizzard.com/en/blizzard/c/api-discussion/18).
